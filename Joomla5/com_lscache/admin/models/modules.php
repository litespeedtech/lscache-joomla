...
/**
 * LSCache Component Module Model
 *
 * @since  1.5
 */
class LSCacheModelModules extends Joomla\CMS\MVC\Model\ListModel
{
	/**
	 * Constructor.
	 *
	...
	protected function populateState($ordering = 'a.position', $direction = 'asc')
	{
		...
		$this->setState('lscache_type', $this->getUserStateFromRequest($this->context . '.lscache_type', 'lscache_type', '', 'cmd'));
	...
	protected function getStoreId($id = '')
	{
		...
		$id .= ':' . $this->getState('filter.cachetype');
	...
	protected function getListQuery()
	{
		...
		if ( $menuItemId = $this->getState('filter.menuitem'))
		{
